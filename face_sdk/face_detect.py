...
with open('config/model_conf.yaml') as f:
    model_conf = yaml.load(f, yaml.SafeLoader)
...
if __name__ == '__main__':
    ...
    # read image
    image_path = 'api_usage/test_images/actor.jpg'
    ...
    # gen result
    save_path_img = 'api_usage/temp/actor_detection.jpg'
    save_path_txt = 'api_usage/temp/actor_detection.txt'
